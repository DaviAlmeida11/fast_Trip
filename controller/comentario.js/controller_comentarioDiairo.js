...
const comentarioDiarioDAO = require('../../model/dao/comentarioDiairo.js')
...
const listarDiarioComentarioId = async function (id) {
  let MESSAGE = JSON.parse(JSON.stringify(MESSAGE_DEFAULT))

  try {
    if (id != '' && id != null && id != undefined && !isNaN(id) && id > 0) {
      let result = await comentarioDiarioDAO.listarDiarioComentario(id)
